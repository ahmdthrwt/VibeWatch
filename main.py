...
DEVELOPER_KEY = "AIzaSyBUed2RZZ3SCc7cVvf7lpJRiQ3S_vMbnUE"  # Set your API key here
...
#    port = int(os.environ.get("WEBSITES_PORT", 8000))  # Use WEBSITES_PORT from Azure or default to 8000
